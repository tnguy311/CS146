...
#Once the order sorted, revisit through it and ensure that all courses can be taken. If any course is encountered that hasn't been marked as completed, it return False. Otherwise, return True.
